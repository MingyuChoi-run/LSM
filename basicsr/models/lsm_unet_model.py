...
from .base_unet_model import BaseUNetModel
...
class LSMUNetModel(BaseUNetModel):
    """Base Deblur model for single image deblur."""

    def __init__(self, opt):
        super(LSMUNetModel, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter):
        ...
        with amp.autocast() if self.opt['train'].get('use_fp16', False) else nullcontext():
